...
# From the version 13 of Fedora, the Boost libraries are delivered with sonames
# equal to the Boost version (e.g., 1.41.0).  On older versions of Fedora
# (e.g., Fedora 12), the Boost libraries are delivered with another scheme for
# sonames (e.g., a soname of 5 for Fedora 12).  If for some reason (for epel
# 5!!) you wish to set the sonamever yourself, you can do it here.
%if 0%{?fedora} >= 13
...
%changelog
* Thu Nov 04 2010 Rudy Grigar <rudy@tag1consulting.com> - 1.44.0-1
- Rebuild for CentOS 5 hphp repo
